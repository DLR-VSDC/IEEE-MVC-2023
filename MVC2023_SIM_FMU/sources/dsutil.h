...
#define HandleEvent2SGodess(cross,xexpr,rel,yexpr,index,ltz,invres) \
	(usingCVodeGodess_ ? (HandleEvent2S(cross,xexpr,rel,yexpr,index,ltz,invres)) : (HandleEvent2(cross,xexpr,rel,yexpr,index,ltz,invres)))
