...
DYMOLA_STATIC int dgetrf_(integer *m, integer *n, doublereal *a, integer *lda, integer *ipiv, integer *info);
DYMOLA_STATIC int dgetrs_(const char *trans, integer *n, integer *nrhs, doublereal *a, integer *lda, const integer *ipiv, doublereal *b, integer *ldb, integer *info);
DYMOLA_STATIC int dgeqpf_(integer *m, integer *n, doublereal *a, integer *lda, integer *jpvt, doublereal *tau, doublereal *work, integer *info);
...
DYMOLA_STATIC int dgetrf__RT(integer *m, integer *n, doublereal *a, integer *lda, integer *ipiv, integer *info)
{	
	return dgetrf_(m,n,a,lda,ipiv,info);
}
DYMOLA_STATIC int dgetrs__RT(const char *trans, integer *n, integer *nrhs, doublereal *a, integer *lda, const integer *ipiv, doublereal *b, integer *ldb, integer *info)
{
	return dgetrs_(trans,n,nrhs,a,lda,ipiv,b,ldb,info);
}
DYMOLA_STATIC int dgeqpf__RT(integer *m, integer *n, doublereal *a, integer *lda, integer *jpvt, doublereal *tau, doublereal *work, integer *info)
{
