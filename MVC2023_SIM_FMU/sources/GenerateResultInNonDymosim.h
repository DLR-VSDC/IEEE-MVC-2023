...
int DeclarePhase0(void**cuser);
int DeclarePhase1(struct DeclarePhase*phase);
int DeclarePhase3(struct DeclarePhase*phase,double startTime,double stopTime,
				   const double*parameters,const double*states,
				   const double*derivatives,
				   const double*outputs,
				   const double*inputs,
				   const double*auxiliary);
int DeclarePhase7(struct DeclarePhase*phase,double time,double tEnd,
				   const double*parameters,const double*states,
				   const double*derivatives,
				   const double*outputs,
				   const double*inputs,
				   const double*auxiliary);
int DeclarePhase9(struct DeclarePhase*phase);
#endif
