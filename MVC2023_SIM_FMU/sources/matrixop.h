...
#define DYNSimpleVectorElement(a,i,n) (DYNX((a),(i-1)))
#define DYNSimpleMatrixElement(a,i,j,n,m) (DYNX((a),(i)*m+(j)-m-1))
#define DYNSimpleArray3Element(a,i,j,k,n,m,o) (DYNX((a),(((i)-1)*m+((j)-1))*o+((k)-1)))
