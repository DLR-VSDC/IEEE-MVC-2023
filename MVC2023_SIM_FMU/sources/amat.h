...
LIBDS_API int amatWriteAll (const char *fileName, AmatFileType ftype, const char *className,
                         const char *version, const char *descr, AclassWrite c[], integer dim_c);
...
LIBDS_API int amatPutOpen (const char *fileName, AmatFileType ftype, AmatBinStruct bstruct,
                        const char *className, const char *version, const char *descr, AmatPutFile *file);
...
DYMOLA_STATIC LIBDS_API_AFTER char **amatTextGen (const char *name, integer nrow);
