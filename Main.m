...
list        = { 'Track No.  1: FTP75',...
                ...
                'Track No.  5: DLR Track 1',...
                'Track No.  6: DLR Track 2',...
                'Track No.  7: DLR Track 3',...
                'Track No.  8: DLR Track 4',...
                'Track No.  9: DLR Track 5' ...
                'Track No. 10: DLR Track 6'};
...
fprintf('Selected track number: %d \n\n',ind)
fprintf('Initializing the Simulink model:\n')
%% System Parameters
